<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Soundmaster.aspx.cs" Inherits="SkySound.SoundAdmin.Soundmaster" %>
				...
				<div class="lijevo">
					...
					<div id="infobox">
					 <ul>
                            ...
                            <li><a href="SoundmanageMember.aspx">用户管理</a></li>
                            <li><a href="SoundSongK.aspx">声音库管理</a></li>
                        </ul>   
					</div>
				</div>
			</div>
